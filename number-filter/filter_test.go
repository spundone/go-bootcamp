...
func TestFilter(t *testing.T) {
	...
	tests := []struct {
		...
		// {
		// 	name:     "OrNumber1",
        //     // prime, greater than 15, multiple of 5
		// 	filterFn: func(nums []int) []int { return orNumbers(nums, primeNumbers, greaterThanN(15), multiplesOf(5)) }, //unsure about this one
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			var result []int
			if tt.name == "EvenMultiplesOf5" || tt.name == "OddMultiplesOf3GreaterThan10" || tt.name == "AndNumber1" || tt.name == "AndNumber2" || tt.name == "OrNumber1" || tt.name == "OrNumber2" {
